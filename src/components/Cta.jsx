...
const Cta = () => {
  return (
    <>
      <section className="d-md-none max-width-100 mb-5 p-5 d-flex justify-center align-center direction-column bg-gru">
      ...
      <section className="d-none d-md-flex row max-width-md-80 m-auto mb-5 p-3 pr-1 bg-gru rounded-10">
        <div className="col-md-6 pl-3 d-flex direction-column justify-center">
          <h2 className="fw-md text-secondary text-lg mb-2">
            Empieza <br /> ahora
          </h2>
